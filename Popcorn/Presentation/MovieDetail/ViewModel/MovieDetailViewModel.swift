...
final class MovieDetailViewModel {
    ...
    init(movieId: Int, fetchMovieDetailUseCase: FetchMovieDetailUseCase, fetchCreditsUseCase: FetchCreditsUseCase, fetchVideoTrailerUseCase: FetchVideoTrialersUseCase) {
