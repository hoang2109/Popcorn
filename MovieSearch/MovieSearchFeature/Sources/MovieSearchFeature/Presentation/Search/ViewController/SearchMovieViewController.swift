...
class SearchMovieViewController: UIViewController, StoryboardInstantiable {
    ...
    static func create(with viewModel: SearchMovieViewModel) -> SearchMovieViewController {
        let controller = SearchMovieViewController.instantiateViewController(Bundle.LibraryName)
    ...
    private func configureResultTableView() {
        let nibName = UINib(nibName: "SearchMovieTableViewCell", bundle: Bundle.LibraryName)
