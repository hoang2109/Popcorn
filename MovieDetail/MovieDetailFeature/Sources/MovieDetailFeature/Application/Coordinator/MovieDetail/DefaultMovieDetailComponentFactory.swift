...
public class DefaultMovieDetailComponentFactory: MovieDetailComponentFactory {
    ...
    public func createMovieDetailViewController(with movieId: Int, coordinator: MovieDetailCoordinator) -> UIViewController {
    ...
    public func createActorDetailViewController(with actorId: Int, coordinator: MovieDetailCoordinator) -> UIViewController {
